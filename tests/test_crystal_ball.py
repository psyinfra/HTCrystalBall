...
class MyTestCase(unittest.TestCase):
    ...
    def test_storage_validator(self):
        ...
        self.assertRaises(argparse.ArgumentTypeError, big_balls.validate_storage_size("20"))
        self.assertRaises(argparse.ArgumentTypeError, big_balls.validate_storage_size("20iGB"))
        self.assertRaises(argparse.ArgumentTypeError, big_balls.validate_storage_size("20GBt"))
        self.assertRaises(argparse.ArgumentTypeError, big_balls.validate_storage_size("20GB3"))
    ...
    def test_slot_config(self):
        ...
        assert "type" in slots[0]

        assert "type" in big_balls.filter_slots(slots, "static")
        assert big_balls.filter_slots(slots, "static")[0]["type"] == "static"

        assert "type" in big_balls.filter_slots(slots, "dynamic")
        assert big_balls.filter_slots(slots, "dynamic")[0]["type"] == "dynamic"

        assert "type" in big_balls.filter_slots(slots, "gpu")
    ...
    def test_slot_checking(self):
        ...
        assert "nodes" in big_balls.check_slots(big_balls.filter_slots(slots, "static"),
                                                big_balls.filter_slots(slots, "dynamic"),
                                                big_balls.filter_slots(slots, "gpu"),
                                                1, 10.0, 0.0, 0, 1, 0.0, 0, verbose=False)
        assert "preview" in big_balls.check_slots(big_balls.filter_slots(slots, "static"),
